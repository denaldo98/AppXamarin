...
{
    class MartediDetailsVM : INotifyPropertyChanged
    {


        private Evento martedi;

        public Evento Martedi
        {
            get { return martedi; }
            set
            {
        ...
        {
            bool result = await DatabaseMartediHelper.UpdateMartedi(Martedi);
            if (result)
        ...
        {
            bool result = await DatabaseMartediHelper.DeleteMartedi(Martedi);
