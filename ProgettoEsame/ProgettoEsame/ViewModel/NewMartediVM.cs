...
{
    public class NewMartediVM : INotifyPropertyChanged
    {
        ...
        public ICommand SaveMartediCommand { get; set; }

        public event PropertyChangedEventHandler PropertyChanged;

        public NewMartediVM()
        {
            SaveMartediCommand = new Command(SaveMartedi, SaveMartediCanExecute);
        }

        private bool SaveMartediCanExecute(object arg)
        {
            return !string.IsNullOrEmpty(Name);

        }

        private void SaveMartedi(object obj)
        {
            bool result = DatabaseMartediHelper.InsertMartedi(new Model.Evento
            {
