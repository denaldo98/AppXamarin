...
{
    public class NewSabatoVM : INotifyPropertyChanged
    {
        ...
        public ICommand SaveSabatoCommand { get; set; }

        public event PropertyChangedEventHandler PropertyChanged;

        public NewSabatoVM()
        {
            SaveSabatoCommand = new Command(SaveSabato, SaveSabatoCanExecute);
        }

        private bool SaveSabatoCanExecute(object arg)
        {
            return !string.IsNullOrEmpty(Name);

        }

        private void SaveSabato(object obj)
        {
            bool result = DatabaseSabatoHelper.InsertSabato(new Model.Evento
            {
