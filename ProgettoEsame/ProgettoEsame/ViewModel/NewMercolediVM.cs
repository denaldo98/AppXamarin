...
{
    public class NewMercolediVM : INotifyPropertyChanged
    {
        ...
        public ICommand SaveMercolediCommand { get; set; }

        public event PropertyChangedEventHandler PropertyChanged;

        public NewMercolediVM()
        {
            SaveMercolediCommand = new Command(SaveMercoledi, SaveMercolediCanExecute);
        }

        private bool SaveMercolediCanExecute(object arg)
        {
            return !string.IsNullOrEmpty(Name);

        }

        private void SaveMercoledi(object obj)
        {
            bool result = DatabaseMercolediHelper.InsertMercoledi(new Model.Evento
            {
