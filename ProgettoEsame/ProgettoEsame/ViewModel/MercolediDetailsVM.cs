...
{
    class MercolediDetailsVM : INotifyPropertyChanged
    {


        private Evento mercoledi;

        public Evento Mercoledi
        {
            get { return mercoledi; }
            set
            {
                mercoledi = value;
                Name = mercoledi.Name;
        ...
        {
            bool result = await DatabaseMercolediHelper.UpdateMercoledi(Mercoledi);
            if (result)
        ...
        {
            bool result = await DatabaseMercolediHelper.DeleteMercoledi(Mercoledi);
