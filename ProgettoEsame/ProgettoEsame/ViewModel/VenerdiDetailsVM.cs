...
{
    class VenerdiDetailsVM : INotifyPropertyChanged
    {


        private Evento venerdi;

        public Evento Venerdi
        {
            get { return venerdi; }
            set
            {
        ...
        {
            bool result = await DatabaseVenerdiHelper.UpdateVenerdi(Venerdi);
            if (result)
        ...
        {
            bool result = await DatabaseVenerdiHelper.DeleteVenerdi(Venerdi);
