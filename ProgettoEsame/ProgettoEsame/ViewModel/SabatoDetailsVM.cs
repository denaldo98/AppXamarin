...
{
    class SabatoDetailsVM : INotifyPropertyChanged
    {


        private Evento sabato;

        public Evento Sabato
        {
            get { return sabato; }
            set
            {
        ...
        {
            bool result = await DatabaseSabatoHelper.UpdateSabato(Sabato);
            if (result)
        ...
        {
            bool result = await DatabaseSabatoHelper.DeleteSabato(Sabato);
